...
import com.emergencia.queue.PriorityQueue;
import com.emergencia.queue.VectorHeap;
...
/**
 * Aplicación principal para la gestión de emergencias usando nuestra implementación de VectorHeap.
 */
public class EmergencyApp {
    private static final Logger logger = LogManager.getLogger(EmergencyApp.class);

    public static void main(String[] args) {
        logger.info("Iniciando Sistema de Atención de Emergencias");
        ...
        // Crear cola de prioridad con nuestra implementación VectorHeap
        PriorityQueue<Paciente> emergencyQueue = new VectorHeap<>();
